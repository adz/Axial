...
/// </summary>
/// <remarks>
/// Calling <see cref="M:Axial.AppHandle`2.Stop" /> more than once is safe. Every caller observes the same
/// final <see cref="T:Axial.Exit`2" /> after the root scope has closed. Disposing the handle requests stop but
