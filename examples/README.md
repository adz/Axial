...
Introductory reference app (Axial.Validation only — checks, `result {}`, `refine {}`, `validate {}`):
...
a conference registration desk using only `Axial.Validation`. It shows reusable checks with your own error
