...
## 5. Decide whether the public type should remain `TelemetryContext`
...
## 6. Stabilize the schedule contract
...
## 7. Remove ambient time from fiber-dump rendering
...
5. `TelemetryContext` type naming.
6. Exact schedule semantics.
7. Ambient time in fiber-dump rendering.
