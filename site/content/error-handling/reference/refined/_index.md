...
- [`Refined.Text.boundedString`](./m-refined-text-boundedstring.md): Builds a string whose length is within an inclusive range.
- [`Refined.Text.slug`](./m-refined-text-slug.md): Builds an ASCII slug made of lowercase letters, digits, and hyphens.
...
- [`Refined.Numeric.nonZeroInt`](./m-refined-numeric-nonzeroint.md): Builds a non-zero integer.
- [`Refined.Numeric.negativeInt`](./m-refined-numeric-negativeint.md): Builds a negative integer.
- [`Refined.Numeric.nonPositiveInt`](./m-refined-numeric-nonpositiveint.md): Builds a non-positive integer.
...
- [`Refined.Temporal.dateTimeOffsetRange`](./m-refined-temporal-datetimeoffsetrange.md): Builds a date and time range where <code>Start &lt;= End</code>.
- [`Refined.Temporal.dateOnlyRange`](./m-refined-temporal-dateonlyrange.md): Builds a date-only range where <code>Start &lt;= End</code>.
...
- [`Refined.Character.isLowercase`](./m-refined-character-islowercase.md): Returns true when the character is lowercase according to invariant Unicode casing.
- [`Refined.Character.isUppercase`](./m-refined-character-isuppercase.md): Returns true when the character is uppercase according to invariant Unicode casing.
- [`Refined.Character.isWhitespace`](./m-refined-character-iswhitespace.md): Returns true when the character is whitespace.
- [`Refined.Character.isControl`](./m-refined-character-iscontrol.md): Returns true when the character is a control character.
- [`Refined.Character.isNumeric`](./m-refined-character-isnumeric.md): Returns true when the character is numeric according to Unicode character data.

## Choice

- [`Refined.Choice.orElse`](./m-refined-choice-orelse.md): Tries the left parser first, then the right parser, mapping either success into a caller-owned output type.
...
- [`Refined.NonBlankString.map`](./m-refined-nonblankstring-map.md): Transforms the value and re-certifies the non-blank invariant.
...
- [`Refined.PositiveInt.map`](./m-refined-positiveint-map.md): Transforms the value and re-certifies the positive integer invariant.
- [`Refined.PositiveInt.replace`](./m-refined-positiveint-replace.md): Replaces the value and re-certifies the positive integer invariant.
