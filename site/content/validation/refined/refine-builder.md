...
If you need to collect multiple independent errors across fields without failing fast, use [`validate {}`]({{< relref "/validation/diagnostics/validate-builder.md" >}}) instead.
