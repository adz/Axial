...
`Validation` and `Diagnostics` ship inside the `Axial.Validation` package — there is no separate package to add:
...
- [Validation API]({{< relref "/validation/reference/validation/" >}})
- [Diagnostics API]({{< relref "/validation/reference/diagnostics/" >}})
