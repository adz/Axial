---
title: "Check.failIfNullable"
linkTitle: "failIfNullable"
weight: 2222
type: docs
---
...
<code><span>Check.failIfNullable&#32;<span>value</span></span></code>
</div>
...
<pre class="fssnip highlighted"><code lang="fsharp"> <span data-fsdocs-tip="fs1" data-fsdocs-tip-unique="1" class="id">System</span><span class="pn">.</span><span data-fsdocs-tip="fs2" data-fsdocs-tip-unique="2" class="id">Nullable</span> <span class="n">5</span> <span class="o">|&gt;</span> <span class="id">Check</span><span class="pn">.</span><span class="id">failIfNullable</span> <span class="c">// Ok 5</span>
 <span data-fsdocs-tip="fs1" data-fsdocs-tip-unique="3" class="id">System</span><span class="pn">.</span><span data-fsdocs-tip="fs2" data-fsdocs-tip-unique="4" class="id">Nullable</span><span class="pn">&lt;</span><span data-fsdocs-tip="fs3" data-fsdocs-tip-unique="5" class="vt">int</span><span class="pn">&gt;</span><span class="pn">(</span><span class="pn">)</span> <span class="o">|&gt;</span> <span class="id">Check</span><span class="pn">.</span><span class="id">failIfNullable</span> <span class="c">// Error ()</span>
</code></pre>
