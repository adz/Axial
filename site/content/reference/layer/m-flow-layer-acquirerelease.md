...
| --- | --- | --- |
| `acquire` | <code><span><a href="/reference/Axial/axial-flow-layer-3.html">Layer</a>&lt;<span>'input,&#32;'error,&#32;'resource</span>&gt;</span></code> | The layer that acquires the resource. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="/reference/Axial/axial-flow-layer-3.html">Layer</a>&lt;<span>'input,&#32;'error,&#32;'resource</span>&gt;</span></code> | A layer that succeeds with the acquired resource. |
