...
| --- | --- | --- |
| `binder` | <code><span>'value&#32;->&#32;<span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'next</span>&gt;</span></span></code> | A function that takes the successful value and returns a new flow. |
| `flow` | <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | The source flow to sequence. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'next</span>&gt;</span></code> | A <a href="../t-flow.md">Flow</a> representing the combined workflow. |

## Remarks


 This is the flatmap operation for <a href="../t-flow.md">Flow</a>. The continuation only runs
