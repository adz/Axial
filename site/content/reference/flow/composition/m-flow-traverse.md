...
| --- | --- | --- |
| `mapping` | <code><span>'value&#32;->&#32;<span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'next</span>&gt;</span></span></code> | A function that maps each value to a flow. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;<span>'next&#32;list</span></span>&gt;</span></code> | A flow containing a list of the successful mapped values. |
