...
| --- | --- | --- |
| `flow` | <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;<span>(<span>'value&#32;->&#32;'next</span>)</span></span>&gt;</span></code> | A flow that contains a function to apply. |
| `value` | <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | A flow that contains the value to apply the function to. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'next</span>&gt;</span></code> | A flow containing the result of applying the function to the value. |
