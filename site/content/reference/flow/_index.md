...
- [`Flow.Flow.catch`](./composition/m-flow-flow-catch.md): Catches exceptions raised during execution and maps them to a typed error.
...
- [`Flow.Flow.Retry`](./scheduling/m-flow-flow-retry.md): Retries a failing flow according to the supplied schedule.
- [`Flow.Flow.Repeat`](./scheduling/m-flow-flow-repeat.md): Repeats a successful flow according to the supplied schedule.
