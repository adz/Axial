...
| --- | --- | --- |
| `fiber` | <code><span><a href="../../fiber/t-fiber.md">Fiber</a>&lt;<span>'error,&#32;'value</span>&gt;</span></code> | The fiber to join. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | A flow that completes with the fiber&#39;s outcome. |
