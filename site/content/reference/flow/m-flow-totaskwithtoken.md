---
title: "Flow.toTaskWithToken"
linkTitle: "toTaskWithToken"
weight: 2206
type: docs
---

Executes a flow and returns a task that resolves to the final exit outcome with an explicit cancellation token.

## Signature

<div class="fsdocs-usage">
<code><span>Flow.toTaskWithToken&#32;<span>environment&#32;cancellationToken&#32;flow</span></span></code>
</div>
