---
title: "Flow.Flow.acquireReleaseWith"
...
| `useResource` | <code><span>'resource&#32;->&#32;<span><a href="/reference/Axial/axial-flow-flow-3.html">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></span></code> | The flow that uses the acquired resource. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="/reference/Axial/axial-flow-flow-3.html">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | A flow that releases the resource after use, including failure paths. |

## Remarks


 Use this for lexical acquire/use/release. For resources that should live until the
 surrounding scope closes, use <a href="/reference/Axial/axial-flow-flow.html#acquireRelease">Flow.acquireRelease</a>.
