...
| --- | --- | --- |
| `errorFlow` | <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'error</span>&gt;</span></code> | A flow that reads the environment to produce an error value. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | A <a href="../t-flow.md">Flow</a> that mirrors the success of the result or fails with the outcome of the error flow. |

## Remarks


 This helper bridges the gap between pure validation (which often uses <a href="https://learn.microsoft.com/dotnet/api/system.result-2">Result</a> or <a href="../../check/t-check.md">Check</a>)
 and the <a href="../t-flow.md">Flow</a> environment model. If the result is an error, the provided <span class="fsdocs-param-name">errorFlow</span>
