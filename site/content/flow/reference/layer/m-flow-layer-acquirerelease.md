...
<code><span>Flow.Layer.acquireRelease&#32;<span>acquire&#32;release</span></span></code>
</div>
...
| `release` | <code><span>'resource&#32;->&#32;Finalizer</span></code> | The release action to run when the layer scope closes. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="t-flow-layer.md">Layer</a>&lt;<span>'input,&#32;'error,&#32;'resource</span>&gt;</span></code> | A layer that succeeds with the acquired resource. |
...
[Source](https://github.com/adz/Axial/blob/main/src/Axial.Flow/RuntimeLayer.fs#L84-84)
