...
- [`Flow.IHas`](./t-flow-ihas.md): Nominal contract for an explicit service dependency.
- [`Flow.Service`](./t-flow-service.md): Typed accessors for explicit and provider-resolved services.

## Service accessors

- [`Flow.Service.get`](./m-flow-service-get.md): Reads a statically declared service from an environment that implements <code>IHas&lt;&#39;service&gt;</code>.
- [`Flow.Service.resolve`](./m-flow-service-resolve.md): Resolves a service dynamically from an <a href="https://learn.microsoft.com/dotnet/api/system.iserviceprovider">IServiceProvider</a> environment.
