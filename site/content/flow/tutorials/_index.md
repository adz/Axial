...
| **[Creating Reusable Services](./custom-services/)** | Named service contracts | Shared helpers that should depend on [`IHas<'service>`]({{< relref "/flow/reference/service/t-flow-ihas.md" >}}) instead of one record field name. |
