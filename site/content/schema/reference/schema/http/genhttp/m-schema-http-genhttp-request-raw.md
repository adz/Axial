---
title: "Schema.Http.GenHttp.Request.raw"
linkTitle: "raw"
weight: 2200
type: docs
---
...
<code><span>Schema.Http.GenHttp.Request.raw&#32;<span>projection</span></span></code>
</div>
...
| --- | --- | --- |
| `projection` | <code><span><a href="https://learn.microsoft.com/dotnet/api/genhttp.api.protocol.irequest">IRequest</a>&#32;->&#32;'input</span></code> | The direct projection from the native request. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="../../../flow/t-flow-flow.md">Flow</a>&lt;<span><span><a href="t-schema-http-genhttp-httpendpointenv.md">HttpEndpointEnv</a>&lt;'app&gt;</span>,&#32;<span><a href="t-schema-http-genhttp-endpointerror.md">EndpointError</a>&lt;'error&gt;</span>,&#32;'input</span>&gt;</span></code> | An endpoint Flow containing the projected, still-untrusted value. |
