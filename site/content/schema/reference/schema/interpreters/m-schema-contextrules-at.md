...
<code><span>Schema.ContextRules.at&#32;<span>path&#32;rule</span></span></code>
</div>
...
<pre class="fssnip highlighted"><code lang="fsharp"> <span class="k">let</span> <span data-fsdocs-tip="fs1" data-fsdocs-tip-unique="1" class="id">scoped</span> <span class="o">=</span> <span class="id">needsReview</span> <span class="o">|&gt;</span> <span class="id">ContextRules</span><span class="pn">.</span><span class="id">at</span> <span class="pn">[</span> <span class="id">PathSegment</span><span class="pn">.</span><span class="id">Name</span> <span class="s">&quot;approval&quot;</span><span class="pn">;</span> <span class="id">PathSegment</span><span class="pn">.</span><span class="id">Name</span> <span class="s">&quot;reviewer&quot;</span> <span class="pn">]</span>
</code></pre>
