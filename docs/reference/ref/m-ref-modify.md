...
| Type | Description |
| --- | --- |
| <code><span><a href="../flow/t-flow.md">Flow</a>&lt;<span>'env,&#32;'none,&#32;'v</span>&gt;</span></code> | A flow that updates the value and returns the second part of the tuple returned by <span class="fsdocs-param-name">f</span>. |
