...
| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | A <a href="../t-flow.md">Flow</a> that succeeds with the option&#39;s value or fails with the provided error. |
