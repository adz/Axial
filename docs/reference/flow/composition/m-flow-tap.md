...
| --- | --- | --- |
| `binder` | <code><span>'value&#32;->&#32;<span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;unit</span>&gt;</span></span></code> | A function that produces a side-effect flow from the successful value. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="../t-flow.md">Flow</a>&lt;<span>'env,&#32;'error,&#32;'value</span>&gt;</span></code> | A <a href="../t-flow.md">Flow</a> that preserves the original success value after the side effect. |
