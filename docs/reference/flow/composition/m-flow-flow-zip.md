...
<code><span>Flow.Flow.zip&#32;<span>left&#32;right</span></span></code>
</div>
...
| `right` | <code><span><a href="/reference/Axial/axial-flow-flow-3.html">Flow</a>&lt;<span>'env,&#32;'error,&#32;'right</span>&gt;</span></code> | The second flow to run. |
