...
| `arg1` | <code><span><a href="t-flowstream.md">FlowStream</a>&lt;<span>'env,&#32;'error,&#32;'v</span>&gt;</span></code> |  |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="t-flowstream.md">FlowStream</a>&lt;<span>'env,&#32;'error,&#32;'w</span>&gt;</span></code> | A new stream that yields transformed values. |
