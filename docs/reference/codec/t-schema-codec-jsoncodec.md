...
<p class='fsdocs-para'>
 Compile once with <a href="/reference/Axial/axial-schema-codec-json.html">Json.compile</a> and reuse the codec for every value. Compilation
