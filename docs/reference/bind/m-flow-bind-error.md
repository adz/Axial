...
<pre class="fssnip highlighted"><code lang="fsharp"> <span class="id">flow</span> <span class="pn">{</span>
     ...
     <span class="k">do!</span> <span class="id">isValid</span> <span class="o">|&gt;</span> <span class="id">Check</span><span class="pn">.</span><span class="id">isTrue</span> <span class="o">|&gt;</span> <span class="id">Bind</span><span class="pn">.</span><span class="id">error</span> <span class="id">InvalidInput</span>
 <span class="pn">}</span>
</code></pre>
