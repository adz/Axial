---
title: "Validation.Schema.JsonLikeValue"
linkTitle: "JsonLikeValue"
weight: 1001
---

A small dependency-free value model for adapting JSON-shaped data into <a href="t-validation-schema-rawinput.md">RawInput</a>.
