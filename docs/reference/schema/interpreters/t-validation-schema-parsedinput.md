---
title: "Validation.Schema.ParsedInput"
...
<p class='fsdocs-para'><code>ParsedInput</code> is the stable handoff value for schema input parsing. Successful parses carry the trusted model in
 <a href="t-validation-schema-parsedinput.md">ParsedInput</a>; failed parses carry path-aware diagnostics while the
 original <a href="t-validation-schema-rawinput.md">RawInput</a> remains available for redisplay and error lookup.
 </p>
