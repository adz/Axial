...
| `workflow` | <code><span><a href="../../../flow/t-flow-flow.md">Flow</a>&lt;<span><span><a href="t-schema-http-genhttp-httpendpointenv.md">HttpEndpointEnv</a>&lt;'app&gt;</span>,&#32;<span><a href="t-schema-http-genhttp-endpointerror.md">EndpointError</a>&lt;'error&gt;</span>,&#32;<a href="t-schema-http-genhttp-httpresponse.md">HttpResponse</a></span>&gt;</span></code> | The complete endpoint Flow to execute. |
