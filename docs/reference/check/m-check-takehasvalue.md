...
<code><span>Check.takeHasValue&#32;<span>value</span></span></code>
</div>
...
| Type | Description |
| --- | --- |
| <code><span><a href="t-check.md">Check</a>&lt;'value&gt;</span></code> | <code>Ok value</code> when <code>HasValue</code> is true; otherwise <code>Error ()</code>. |
