...
<code><span>Result.Check.fromTry&#32;<span><span>(<span>arg1,&#32;arg1</span>)</span></span></span></code>
</div>
...
| Type | Description |
| --- | --- |
| <code><span><a href="/reference/Axial/axial-result-check-1.html">Check</a>&lt;'value&gt;</span></code> | <code>Ok value</code> when the flag is true; otherwise <code>Error ()</code>. |
