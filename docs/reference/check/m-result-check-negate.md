...
<code><span>Result.Check.negate&#32;<span>check</span></span></code>
</div>
...
| --- | --- | --- |
| `check` | <code><span><a href="/reference/Axial/axial-result-check-1.html">Check</a>&lt;'value&gt;</span></code> | The source check. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="/reference/Axial/axial-result-check-1.html">Check</a>&lt;unit&gt;</span></code> | A unit-success check with inverted success/failure. |
