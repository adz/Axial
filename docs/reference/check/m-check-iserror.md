...
<code><span>Check.isError&#32;<span>result</span></span></code>
</div>
...
| Type | Description |
| --- | --- |
| <code><span><a href="t-check.md">Check</a>&lt;unit&gt;</span></code> | <code>Ok ()</code> when the result is <code>Error</code>; otherwise <code>Error ()</code>. |
