...
| Type | Description |
| --- | --- |
| <code><span><a href="t-validation-validation.md">Validation</a>&lt;<span>unit,&#32;'error</span>&gt;</span></code> | A validation that keeps the original diagnostics and discards the success value. |
