...
| --- | --- | --- |
| `binder` | <code><span>'value&#32;->&#32;<span><a href="t-validation-validation.md">Validation</a>&lt;<span>'next,&#32;'error</span>&gt;</span></span></code> | A function of type <code>&#39;value -&gt; Validation&lt;&#39;next, &#39;error&gt;</code>. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="t-validation-validation.md">Validation</a>&lt;<span>'next,&#32;'error</span>&gt;</span></code> | The result of the binder or the original diagnostics. |
