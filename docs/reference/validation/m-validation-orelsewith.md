...
| --- | --- | --- |
| `fallback` | <code><span><span><a href="../diagnostics/t-diagnostics.md">Diagnostics</a>&lt;'error&gt;</span>&#32;->&#32;<span><a href="t-validation.md">Validation</a>&lt;<span>'value,&#32;'error</span>&gt;</span></span></code> | A function that turns the diagnostics into an alternate validation. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="t-validation.md">Validation</a>&lt;<span>'value,&#32;'error</span>&gt;</span></code> | The source validation when it succeeds, otherwise the computed fallback validation. |
