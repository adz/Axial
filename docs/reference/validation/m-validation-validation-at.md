...
<code><span>Validation.Validation.at&#32;<span>path&#32;validation</span></span></code>
</div>
...
| --- | --- | --- |
| `path` | <code><span><a href="/reference/Axial/axial-validation-pathsegment.html">PathSegment</a>&#32;list</span></code> | The path segments to apply to the validation. |
...
| Type | Description |
| --- | --- |
| <code><span><a href="/reference/Axial/axial-validation-validation-2.html">Validation</a>&lt;<span>'value,&#32;'error</span>&gt;</span></code> | A validation nested under the given path. |
