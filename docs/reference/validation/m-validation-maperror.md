...
| `validation` | <code><span><a href="t-validation.md">Validation</a>&lt;<span>'value,&#32;'error</span>&gt;</span></code> | The source <a href="t-validation.md">Validation</a>. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="t-validation.md">Validation</a>&lt;<span>'value,&#32;'nextError</span>&gt;</span></code> | A validation with transformed error values. |
