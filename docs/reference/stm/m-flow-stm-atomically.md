...
<code><span>Flow.STM.atomically&#32;<span>transaction</span></span></code>
</div>
...
| --- | --- | --- |
| `transaction` | <code><span><a href="/reference/Axial/axial-flow-stm-1.html">STM</a>&lt;'T&gt;</span></code> | The STM transaction to execute. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="/reference/Axial/axial-flow-flow-3.html">Flow</a>&lt;<span>'env,&#32;'none,&#32;'T</span>&gt;</span></code> | A flow that performs the transaction and returns its result. |
