...
The [Application Lifecycle](/platforms-and-hosting/application-lifecycle.html) guide covers start and stop ownership. Hosting
...
- [Scopes and Resources](/scopes/index.html) explains finalizers and
