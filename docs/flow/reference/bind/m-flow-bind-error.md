...
<pre class="fssnip highlighted"><code lang="fsharp"> <span class="id">flow</span> <span class="pn">{</span>
     ...
     <span class="k">do!</span> <span data-fsdocs-tip="fs1" data-fsdocs-tip-unique="1" class="id">Result</span><span class="pn">.</span><span class="id">requireTrue</span> <span class="pn">(</span><span class="pn">)</span> <span class="id">isValid</span> <span class="o">|&gt;</span> <span class="id">Bind</span><span class="pn">.</span><span class="id">error</span> <span class="id">InvalidInput</span>
 <span class="pn">}</span>
</code></pre>
