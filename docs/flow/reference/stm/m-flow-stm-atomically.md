...
| --- | --- | --- |
| `transaction` | <code><span><a href="t-flow-stm.md">STM</a>&lt;'T&gt;</span></code> | The STM transaction to execute. |

## Returns

| Type | Description |
| --- | --- |
| <code><span><a href="../flow/t-flow-flow.md">Flow</a>&lt;<span>'env,&#32;'none,&#32;'T</span>&gt;</span></code> | A flow that performs the transaction and returns its result. |
