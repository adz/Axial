...
description: Learn Flow one concept at a time, from its type to a running application.
---

# Getting Started

This section introduces Flow in dependency order. Start with the problem it solves, then learn how to describe,
combine, and run workflows before adding dependencies or application lifecycle.

| Step | Page | What it adds |
| --- | --- | --- |
| 1 | [Why Flow?](./why-flow/) | The gap between ordinary async code and an explicit workflow model |
