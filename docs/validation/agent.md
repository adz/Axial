...
Use this section for `Axial.Validation`. The package does not require Schema or Flow.
...
For compact prompt context, load [`/validation/llms.txt`](/validation/llms.txt).
