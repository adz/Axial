...
Continue with the [Explicit Dependencies tutorial](/dependencies/tutorial-explicit-dependencies.html) before
introducing Layers.
...
- [Dependencies](/dependencies/dependencies.html) compares arguments, records, named
  services, and Layers.
- [App Record tutorial](/dependencies/tutorial-app-record.html) builds a feature over a concrete environment record.
- [Creating Reusable Services](/dependencies/tutorial-custom-services.html) introduces nominal service
